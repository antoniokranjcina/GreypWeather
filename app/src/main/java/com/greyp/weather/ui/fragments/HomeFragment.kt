...
@AndroidEntryPoint
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener, View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.getWeatherByCityName(cityName = "Grad Zagreb")
    }
    ...
    private fun setupOnClickListeners() {
        binding.apply {
            buttonRetry.setOnClickListener(this@HomeFragment)
        }
    }
