...
class LocationWeatherDaoTest {
    ...
    private lateinit var dao: LocationWeatherDao

    @Before
    fun setup() {
        hiltRule.inject()
        dao = database.locationWeatherDao()
    }
    ...
    @Test
    fun insertLocationWeatherTest() = runBlockingTest {
        dao.insertWeather(locationWeather = locationWeather)
    ...
    @Test
    fun deleteLocationWeatherTest() = runBlockingTest {
        dao.apply {
            insertWeather(locationWeather = locationWeather)
            deleteAllWeather()
        }
        val result = dao.getWeather()
